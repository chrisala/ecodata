...
ssh -i ~/.ssh/ala-fieldcapture-tes.pem ubuntu@fieldcapture-dev.ala.org.au 'cd /data/ecodata/; tar --exclude-vcs -cf models.tar models'
scp -i ~/.ssh/ala-fieldcapture-tes.pem ubuntu@fieldcapture-dev.ala.org.au:/data/ecodata/models.tar ./datamodels
cd datamodels
